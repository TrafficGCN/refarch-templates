...
class PostsUsersControllerTest {
    ...
    @Test
    void getUsersByPost_ShouldReturnListOfUsers() throws Exception {
    ...
    @Test
    void getPostsByUser_ShouldReturnListOfPosts() throws Exception {
    ...
    @Test
    void assignUserToPost_ShouldAssignAndReturnAssociation() throws Exception {
    ...
    @Test
    void removeUserFromPost_ShouldRemoveAssociation() throws Exception {
        doNothing().when(postsUsersService).removeUserFromPost(postLinkId, userId);
