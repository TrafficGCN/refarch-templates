...
class PagesUsersRepositoryTest {
    ...
    void findByPageLinkId_WhenExists_ShouldReturnList() {
        // Act
        List<PagesUsers> result = pagesUsersRepository.findByPageLinkId(pageLinkId);
    ...
    void findByPageLinkId_WhenDoesNotExist_ShouldReturnEmptyList() {
        // Act
        List<PagesUsers> result = pagesUsersRepository.findByPageLinkId(UUID.randomUUID());
    ...
    void findByUserId_WhenExists_ShouldReturnList() {
        // Act
        List<PagesUsers> result = pagesUsersRepository.findByUser_Id(user.getId());
    ...
    void findByUserId_WhenDoesNotExist_ShouldReturnEmptyList() {
        // Act
        List<PagesUsers> result = pagesUsersRepository.findByUser_Id(UUID.randomUUID());
    ...
    void deleteByPageLinkIdAndUserId_WhenExists_ShouldDelete() {
        // Act
        pagesUsersRepository.deleteByPageLinkIdAndUser_Id(pageLinkId, user.getId());
        entityManager.flush();

        // Assert
        PagesUsers foundPagesUsers = entityManager.find(PagesUsers.class, pagesUsers.getId());
    ...
    void save_ShouldCreatePagesUsers() {
        // Arrange
        UUID newPageLinkId = UUID.randomUUID();
        PagesUsers newPagesUsers = new PagesUsers();
        newPagesUsers.setPageLinkId(newPageLinkId);
        newPagesUsers.setUser(user);

        // Act
        PagesUsers savedPagesUsers = pagesUsersRepository.save(newPagesUsers);

        // Assert
        PagesUsers foundPagesUsers = entityManager.find(PagesUsers.class, savedPagesUsers.getId());
